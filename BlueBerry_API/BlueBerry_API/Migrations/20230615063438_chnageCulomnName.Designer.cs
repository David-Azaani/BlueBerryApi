...
namespace BlueBerry_API.Migrations
{
    ...
    [Migration("20230615063438_chnageCulomnName")]
    partial class chnageCulomnName
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BlueBerry_API.Model.ApplicationUser", b =>
                {
            ...
            modelBuilder.Entity("BlueBerry_API.Model.OrderDetails", b =>
                {
            ...
            modelBuilder.Entity("BlueBerry_API.Model.OrderHeader", b =>
                {
                    b.Property<int>("OrderHeaderId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("BlueBerry_API.Model.OrderDetails", b =>
                {
                    ...
                    b.HasOne("BlueBerry_API.Model.OrderHeader", null)
            ...
            modelBuilder.Entity("BlueBerry_API.Model.OrderHeader", b =>
                {
                    b.HasOne("BlueBerry_API.Model.ApplicationUser", "User")
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("BlueBerry_API.Model.ApplicationUser", null)
                        .WithMany()
